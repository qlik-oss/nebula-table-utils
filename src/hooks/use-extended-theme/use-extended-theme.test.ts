...
describe('getBackgroundColors', () => {
  ...
  const chartBackgroundResolver = (t: stardust.Theme) => t.getStyle('', '', 'object.straightTableV2.backgroundColor');
  const objectBackgroundResolver = (t: stardust.Theme) => t.getStyle('', '', 'backgroundColor');
  const theme = {
  ...
  describe('mashup', () => {
    ...
    describe('when there is no background color in the theme file', () => {
      it('should return the valueWithLightBackgroundColor', () => {
        const result = getBackgroundColors(theme, rootElement, chartBackgroundResolver, objectBackgroundResolver);
